...
const playersRaw: any[] = [
  ...
  { id: 'l-kin-5', name: 'Jahid', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 61, secondarySkill: 22, style: 'A', isOpener: false, isForeign: false },
  ...
  { id: 'l-sta-5', name: 'Shoaib Khan', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 56, secondarySkill: 25, style: 'D', isOpener: false, isForeign: false },
  { id: 'l-sta-6', name: 'A. Jamal', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 59, secondarySkill: 0, style: 'A', isOpener: false, isForeign: false },
  ...
  { id: 'l-sta-15', name: 'Ashfaq', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 55, secondarySkill: 10, style: 'D', isOpener: false, isForeign: false },
  ...
  { id: 'l-six-6', name: 'Zakir', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 59, secondarySkill: 11, style: 'D', isOpener: false, isForeign: false },
  ...
  { id: 'l-haw-4', name: 'Altaf', nationality: 'Local', role: PlayerRole.BATSMAN, battingSkill: 55, secondarySkill: 10, style: 'N', isOpener: true, isForeign: false },
