        ...
        <div className="h-full flex flex-col items-center justify-center p-4 md:p-10 bg-[#050808] relative overflow-hidden font-sans text-[#E4E3E0]">
            ...
            <div className="relative z-10 w-full max-w-3xl flex flex-col items-center">
                ...
                >
                    ...
                    <h1 className="text-7xl md:text-[13rem] font-black italic uppercase tracking-tighter leading-[0.8] text-white font-display mb-6 md:mb-12 drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                        CRICKET<br/>
                        <span className="text-teal-500 font-light not-italic">MANAGER</span>
                    </h1>
                    
                    <div className="flex items-center justify-center gap-6 md:gap-16 mt-4 md:mt-10">
                        <div className="h-[1.5px] w-16 md:w-32 bg-gradient-to-r from-transparent to-white/10" />
                        <span className="text-6xl md:text-[12rem] font-black italic text-white/10 font-display tracking-[0.2em] drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]">26</span>
                        <div className="h-[1.5px] w-16 md:w-32 bg-gradient-to-l from-transparent to-white/10" />
                    </div>
                </motion.div>
                ...
                <div className="w-full space-y-5 md:space-y-8 mb-8 md:mb-24">
                            ...
                            >
                                ...
                                <div className="relative flex items-center justify-between">
                                    <div className="flex items-center gap-6 md:gap-12">
                                        <div className="w-14 h-14 md:w-24 md:h-24 bg-black/10 rounded-2xl md:rounded-4xl flex items-center justify-center shadow-inner">
                    ...
                    >
                        <div className="relative flex items-center justify-between">
                            <div className="flex items-center gap-6 md:gap-12">
                                <div className="w-14 h-14 md:w-24 md:h-24 bg-white/5 rounded-2xl md:rounded-4xl flex items-center justify-center text-teal-500 group-hover:rotate-12 transition-transform duration-500">
