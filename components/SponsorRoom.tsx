...
const SponsorRoom: React.FC<SponsorRoomProps> = ({ gameData, setGameData }) => {
    ...
    const selectedFormat = formats.includes(selectedFormatState) ? selectedFormatState : formats[0];

    const sponsorship = (gameData.sponsorships as any)[selectedFormat] || (INITIAL_SPONSORSHIPS as any)[selectedFormat];
    const currentThresholds = (SPONSOR_THRESHOLDS as any)[selectedFormat];
        ...
        <div className="h-[calc(100vh-90px)] overflow-y-auto bg-slate-50 dark:bg-slate-900 flex flex-col">
            ...
            <div className="bg-slate-900 dark:bg-slate-950 p-4 pb-2 text-white sticky top-0 z-10 shadow-md">
                ...
                <select
                    ...
                    onChange={(e) => setSelectedFormatState(e.target.value as Format)}
